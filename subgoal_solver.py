...
def objective(opt_vars,
    ...
    """
    Args:
        opt_vars: optimization variables
        og_bounds: omnigibson env boundings
        keypoints_centered: keypoints converted from world frame
        goal/path_constraints: constraints generated by VLM
        sdf_func: get a voxel value from a sdf grid function defined by max/min bound and conlision points
    """
    debug_dict = {}
